...
label.Size = UDim2.new(1, 0, 0.9, 0)
...
label2.Size = UDim2.new(0.5, 0, 0.3, 0)
label2.Position = UDim2.new(0.175, 0, 0.1, 0)
...
button.Size = UDim2.new(0.075, 0, 0.075, 0)
button.Position = UDim2.new(0, 0, 0.925, 0)
...
stroke2.Thickness = 0.5

button2.Size = UDim2.new(0.075, 0, 0.075, 0)
button2.Position = UDim2.new(0.075, 0, 0.925, 0)
button2.Text = "AT: Off"
button2.BackgroundTransparency = 0.3
button2.BackgroundColor3 = Color3.new(0.8, 0, 0)
button2.TextSize = 12
...
textbox.Size = UDim2.new(0.075, 0, (0.075 / 2), 0)
textbox.Position = UDim2.new(0.15, 0, 0.925, 0)
...
button3.Size = UDim2.new(0.075, 0, (0.075 / 2), 0)
button3.Position = UDim2.new(0.15, 0, 0.962, 0)
button3.BackgroundColor3 = Color3.new(0.1, 0.1, 0.1)
button3.TextColor3 = Color3.new(1, 1, 1)
button3.Text = "Apply Speed"
button3.BackgroundTransparency = 0.3

button4.Size = UDim2.new(0.043, 0, (0.75 / 2), 0)
button4.Position = UDim2.new(0.226, 0, 0.962, 0)
button4.Text = "Humanlike"
button4.BackgroundTransparency = 0.3
button4.BackgroundColor3 = Color3.new(0.1, 0.1, 0.1)
button4.TextSize = 8
button4.TextColor3 = Color3.new(1, 1, 1)

local site =
	game:HttpGet("https://raw.githubusercontent.com/Artzified/WordBombDictionary/refs/heads/main/words.txt", true)
...
function findWords(letters)
	...
	local result = {}
	for i = 1, math.min(10000, #wordlist) do
...
button.Activated:Connect(function()
	...
	elseif currentSort == 2 then
		button.BackgroundColor3 = Color3.new(0, 0, 0.8)
	...
	local ifn =
		lp.PlayerGui.GameUI.Container.GameSpace.DefaultUI.GameContainer.DesktopContainer.InfoFrameContainer.InfoFrame
...
button2.Activated:Connect(function()
	...
	if autotyping then
		if humanLike then
			button2.BackgroundColor3 = Color3.new(0, 0, 0.8)
			button2.Text = "AT: Humanlike"
		else
			button2.BackgroundColor3 = Color3.new(0, 0.8, 0)
			button2.Text = "AT: On"
		end
	else
		button2.BackgroundColor3 = Color3.new(0.8, 0, 0)
...
button4.Activated:Connect(function()
	...
	if humanLike then
		...
		button4.BackgroundColor3 = Color3.new(0, 0.8, 0)
	else
		if autotyping then
			button2.BackgroundColor3 = Color3.new(0, 0.8, 0)
			button2.Text = "AT: On"
...
function autotype(result)
	...
	if not humanLike then
		...
		for _, v in next, result:split("") do
			...
			task.wait(
				1 / ((writingSpeed * 2) / math.random(1, 60))
					+ 1 / (hd[math.random(1, 20)] * math.random(1, 3)) / math.random(1, 60)
			)
...
function handler(ifn, tx)
	if ifn:FindFirstChild("Title").Text == "Quick! Type an English word containing:" then
		...
		if autotyping then
			if table.find(blacklist, result[a]) then
				warn("Blacklisted word found: " .. result[rnd] .. ". Skipping...")

				a += 1
			end

			label2.Text = result[a]
			autotype(result[a])
		else
